...
var EditorSelection = class EditorSelection {
	...
	*/
	static range(anchor, head, goalColumn, bidiLevel, assoc) {
		...
		return head < anchor ? SelectionRange.create(head, anchor, 48 | flags) : SelectionRange.create(anchor, head, (!assoc ? 0 : assoc < 0 ? 8 : 16) | flags);
	}
	/**
	@internal
	*/
...
//#endregion
export { EditorState as $, ViewPlugin as A, hoverTooltip as B, indentUnit as C, Decoration as D, syntaxTree as E, dropCursor as F, showDialog as G, lineNumbers as H, getPanel as I, Annotation as J, showPanel as K, highlightActiveLine as L, activateHover as M, crosshairCursor as N, Direction as O, drawSelection as P, EditorSelection as Q, highlightActiveLineGutter as R, indentString as S, Tree as St, syntaxHighlighting as T, rectangularSelection as U, keymap as V, runScopeHandlers as W, ChangeSet as X, ChangeDesc as Y, CharCategory as Z, foldNodeProp as _, NodeProp as _t, completionKeymap as a, Text as at, indentNodeProp as b, NodeWeakMap as bt, IndentContext as c, codePointSize as ct, bracketMatching as d, findClusterBreak as dt, Facet as et, defaultHighlightStyle as f, fromCodePoint as ft, foldKeymap as g, IterMode as gt, foldInside as h, DefaultBufferLength as ht, completeFromList as i, StateField as it, WidgetType as j, EditorView as k, LRLanguage as l, combineConfig as lt, foldGutter as m, tags as mt, closeBrackets as n, RangeSetBuilder as nt, ifNotIn as o, Transaction as ot, delimitedIndent as p, styleTags as pt, crelt as q, closeBracketsKeymap as r, StateEffect as rt, snippetCompletion as s, codePointAt as st, autocompletion as t, Prec as tt, LanguageSupport as u, countColumn as ut, getIndentUnit as v, NodeSet as vt, matchBrackets as w, indentOnInput as x, Parser as xt, getIndentation as y, NodeType as yt, highlightSpecialChars as z };

//# sourceMappingURL=dist-Ctla5ozN.js.map